...
diffractive = 5;
load("measurement_psf_diffractive="+num2str(diffractive)+".mat")
for j=1:4
    for i=1:3
        x = Y_rgb_noisy(:,:,i,j);
...
save("X_rec_diffractive="+num2str(diffractive)+".mat",'x_rgb')
figure(3); %colormap gray;
title('TwIST restored image')
for i=1:4
    subplot(1,4,i),imagesc(x_rgb(:,:,:,i)),pbaspect([1 1 1]); axis off;
end
